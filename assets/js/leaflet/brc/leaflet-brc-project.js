...
L.geoJson(statesData, { //statesData is in bostonboundaries.js
    style: style
}).addTo(map);
...
function createPopUpHtmlForBinding(binding) {
    ...
    if (binding["work"]) {
        ...
        //popUpHtml += "<a href = '" + binding["work"] + "' class='more-info-span' target='_blank'>More information.... <img src='../wp-content/plugins/drs-tk/libraries/Ceres/assets/images/brc/external-link.svg' width='10' heigth='10'></a>"
    }
